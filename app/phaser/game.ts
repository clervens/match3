...
export class Game extends Phaser.Game {
    ...
    constructor() {
       ...
       */
      (<any>window).scaleRatio = window.devicePixelRatio / 3;
      ...
      // Performance fix
      // SOURCE: http://www.html5gamedevs.com/topic/13514-simple-game-horrible-performance-on-androidcooconjs/?do=findComment&comment=77195
